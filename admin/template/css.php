...
body {
	height: 100%;
	font-family: Sahel,  Arial, Helvetica Neue, Helvetica, sans-serif;
	font-size: 12px;
	background: #f6f6f6;
	direction: rtl;
}
...
.unformatted {
	white-space: pre;
	font-family: Sahel,  Consolas, "Andale Mono WT", "Andale Mono", "Lucida Console", "Lucida Sans Typewriter", "DejaVu Sans Mono", "Bitstream Vera Sans Mono", "Liberation Mono", "Nimbus Mono L", Monaco, "Courier New", Courier, monospace;
	line-height: 15px;
	font-size: 11px;
	display: block;
	padding-bottom: 15px;
...
.header h1 {
	font-size: 25px;
	font-family: Sahel,  Georgia, Times, Times New Roman, serif;
	position: absolute;
...
textarea#codetext {
	height: 660px;
	width: 99%;
	font-family: Sahel,  Consolas, Monaco, "Courier New", Courier, monospace;
	font-size: 12px;
	line-height: 18px;
	overflow: scroll;
	overflow-y: scroll;
